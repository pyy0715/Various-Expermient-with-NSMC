...
if __name__ == "__main__":
   ...
   class BiGRU(nn.Module):
      def __init__(self, hidden_dim:int, n_layers:int, n_vocab:int, embed_dim:int, n_classes=2, dropout_p=0):
      ...
      def _init_state(self, batch_size=1):
         ...
         # return weight.new(int(self.n_layers[0]*2), batch_size, int(self.hidden_dim[0])).zero_()
