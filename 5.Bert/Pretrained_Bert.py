...
class Pretrained_Sentimental_Classifer(nn.Module):
   def __init__(self, n_class, pretrain_name):
      super(Pretrained_Sentimental_Classifer, self).__init__()
...
if __name__ == "__main__":
   ...
   model = Pretrained_Sentimental_Classifer(n_class=2, pretrain_name = PRE_TRAINED_MODEL_NAME).to(device)
